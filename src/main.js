...
const searchMarkup = () => `<section class="main__search search container">
        <input
          type="text"
          id="search__input"
          class="search__input"
...
const filterMarkup = () => `<section class="main__filter filter container">
        <input
          type="radio"
          id="filter__all"
...
const contentMarkup = () => `<section class="board container">
...
const cardEditMarkup = () => `<article class="card card--edit card--yellow card--repeat">
...
const prepareSite = () => {
  render(headerElement, menuMarkup(), `beforeEnd`);
  render(mainElement, searchMarkup(), `beforeEnd`);
  render(mainElement, filterMarkup(), `beforeEnd`);
  render(mainElement, contentMarkup(), `beforeEnd`);
