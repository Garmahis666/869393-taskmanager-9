...
const getFilterMarkup = () => `<section class="main__filter filter container">
  <input
    type="radio"
    id="filter__all"
...
const getContentMarkup = () => `<section class="board container">
...
const getCardMarkup = (cardText, cardColor = `black`, cardRepeat = false, cardDeadLineDate = null, cardTags = []) => {
